                ...
                children: [
                  ...
                  IconButton(
                    ...
                    onPressed: () => showModalBottomSheet(
                      ...
                      context: context,
                      builder: (_) {
                        context.read<RecipeFilterProvider>()
                          ..listFound = _listFound
                          ..displayRoutingResult();
                        return const _RecipeFilter();
                      },
...
class _RecipeFilter extends StatelessWidget {
  const _RecipeFilter({super.key});
                  ...
                  return TextButton(
                    onPressed: () {
                      recipeFilterProvider
                          .submitFilter(recipeFilterProvider.listFound);
                ...
                builder: (context, provider, child) {
                  return TextButton(
                    ...
                    style: TextButton.styleFrom(
                      ...
                      side:
                          const BorderSide(color: Palette.orange500, width: 2),
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(20.r),
                      ),
                    ),
